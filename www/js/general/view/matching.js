angular.module("matchingGeneral-controller",[])
.controller("matchingGeneralCtrl",function($scope,$ionicHistory,$http,$httpParamSerializerJQLike,$localstorage){
 ...
 document.getElementById("matchingListLeft").classList.add("tab-item-active");
  ...
  $scope.selboxData = {
        resume_list : [ {resume_data_no:"",title:"이력서 제목 입니다."}
        ]
  }
  //$scope.uid                     = "p20513";
  $scope.matching                = {};
