angular.module('emergnecychurchRegi', [])
.controller('ecrCtrl', function($scope, $localstorage, $state, $http, $httpParamSerializerJQLike, $ionicPopup, Popup,$ionicPopover) {
    ...
    $ionicPopover.fromTemplateUrl('templates/emergency/popover.html', {
      scope: $scope,
