angular.module('churchRegi-controller', [])
.controller('churchRegi', function($scope, $localstorage, $state, $http, $httpParamSerializerJQLike, $ionicPopup, Popup,$ionicHistory,$window) {
    $scope.button11 = [{ button1: "채용 공고 새로 작성" }];
    $scope.button22 = [{ button2: "긴급 구인" }];
